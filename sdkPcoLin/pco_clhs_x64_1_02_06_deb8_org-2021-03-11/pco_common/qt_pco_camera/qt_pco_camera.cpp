...
void qt_pco_camera::on_OpenCameraButton_clicked()
{
    ...
    if(Interfacetype==INTERFACE_FIREWIRE)
    {
     grabber=new CPco_grab_1394((CPco_com_1394*)camera);
    }
#endif

#ifdef CPCO_GRAB_CLHS_H
    if(Interfacetype==INTERFACE_CAMERALINKHS)
    {
     grabber=new CPco_grab_clhs(camera);
    }
#endif
